...
## 공분산과 상관성 분석
타깃 변수 Y와 입력변수 X와의 관계는 물론 입력변수 X들 간의 관계도 살펴봐야 한다.       
이를 통해 독립 변수의 변화에 따른 종속 변수의 변화량을 크게하여 통계적 정확도를 감소시키는 다중공선성을 방지할 수 있음.
![alt text](cov.PNG)
![alt text](corr.PNG)

## 변수 척도에 따른 상관분석 방법
![alt text](<상관분석 방법.PNG>)
...
![alt text](4week_1.PNG)

![alt text](4week_2.PNG)

![alt text](4week_3.PNG)

![alt text](4week_4.PNG)
